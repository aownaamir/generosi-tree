function Money({ width = "50px", height = "50px", fill, className }) {
  return (
    <svg
      // fill={fill}
      // height={width}
    ...
    >
      <g>
        <path
          d="M486,215.481l-293.4-169.3c-4-2.3-10.6-2.3-14.6,0L3.2,147.781c-4,2.3-4,6.1,0,8.5l293.3,169.3c4.1,2.4,10.6,2.3,14.6,0
