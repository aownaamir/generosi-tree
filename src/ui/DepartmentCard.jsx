...
function DepartmentCard({ item }) {
  return (
    <Link to={`${item.url}`}>
      <div className="w-64 lg:w-64 h-40 group   border-4 border-chat-brown flex flex-col gap-3 text-lg rounded-lg overflow-hidden justify-center items-center step-shadow hover:border-0 transition-all duration-[320ms] relative ">
